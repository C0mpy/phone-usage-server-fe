...
import { SurveyResultShowComponent } from './survey-result-show/survey-result-show.component';
...
@NgModule({
  imports: [
    RouterModule.forRoot([
      ...
      { path: 'survey-results/:surveyResultId', component: SurveyResultShowComponent }
    ])
  ],
